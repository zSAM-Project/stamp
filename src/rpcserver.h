...
extern UniValue setzsamseed(const UniValue& params, bool fHelp);
extern UniValue getzsamseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsam(const UniValue& params, bool fHelp);
extern UniValue dzsamstate(const UniValue& params, bool fHelp);
