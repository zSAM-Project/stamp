...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Stamp Core stamp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stamp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stamp transaction") + "\n" +
                               "  stamp-tx [options] -create [commands]   " + _("Create hex-encoded stamp transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stamp transaction
