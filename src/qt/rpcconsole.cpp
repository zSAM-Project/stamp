                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSAMPathCustom = GetArg("-zsambackuppath", "");
    ...
    if(!strzSAMPathCustom.empty()) {
        ui->wallet_customzsambackuppath->setText(QString::fromStdString(strzSAMPathCustom));
        ui->wallet_customzsambackuppath_label->setVisible(true);
        ui->wallet_customzsambackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSAMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the STAMP RPC console.") + "<br>" +
