                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("STAMP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STAMP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stamp: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSAM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About STAMP Core"), this);
    aboutAction->setStatusTip(tr("Show information about STAMP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STAMP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STAMP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STAMP addresses"));
    ...
    openAction->setStatusTip(tr("Open a STAMP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the STAMP Core help message to get a list with possible STAMP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("STAMP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STAMP network", "", count));
}
...
{
    QString strTitle = tr("STAMP Core"); // default title
