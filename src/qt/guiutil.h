...
/** Utility functions used by the STAMP Qt UI.
 */
namespace GUIUtil
{
...
// Render STAMP addresses in monospace font
...
// Parse "stamp:" URI into recipient object, return true on successful parsing
