...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* STAMP features */
        {"stamp", "masternode", &masternode, true, true, false},
        {"stamp", "listmasternodes", &listmasternodes, true, true, false},
        {"stamp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"stamp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"stamp", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"stamp", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"stamp", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"stamp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"stamp", "masternodedebug", &masternodedebug, true, true, false},
        {"stamp", "startmasternode", &startmasternode, true, true, false},
        {"stamp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"stamp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"stamp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"stamp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"stamp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"stamp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"stamp", "mnbudget", &mnbudget, true, true, false},
        {"stamp", "preparebudget", &preparebudget, true, true, false},
        {"stamp", "submitbudget", &submitbudget, true, true, false},
        {"stamp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"stamp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"stamp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"stamp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"stamp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"stamp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"stamp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stamp", "checkbudgets", &checkbudgets, true, true, false},
        {"stamp", "mnsync", &mnsync, true, true, false},
        {"stamp", "spork", &spork, true, true, false},
        {"stamp", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsamseed", &getzsamseed, false, false, true},
        {"zerocoin", "setzsamseed", &setzsamseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsam", &searchdzsam, false, false, true},
        {"zerocoin", "dzsamstate", &dzsamstate, false, false, true}
...
{
    return "> stamp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43453/\n";
}
