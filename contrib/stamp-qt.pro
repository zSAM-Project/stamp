...
RESOURCES += src/qt/stamp.qrc src/qt/stamp_locale.qrc

TRANSLATIONS += src/qt/locale/stamp_bg.ts \
                src/qt/locale/stamp_de.ts \
                src/qt/locale/stamp_en.ts \
                src/qt/locale/stamp_es.ts \
                src/qt/locale/stamp_fi.ts \
                src/qt/locale/stamp_fr.ts \
                src/qt/locale/stamp_it.ts \
                src/qt/locale/stamp_ja.ts \
                src/qt/locale/stamp_pl.ts \
                src/qt/locale/stamp_pt.ts \
                src/qt/locale/stamp_ru.ts \
                src/qt/locale/stamp_sk.ts \
                src/qt/locale/stamp_sv.ts \
                src/qt/locale/stamp_vi.ts \
                src/qt/locale/stamp_zh_CN.ts \
                src/qt/locale/stamp_zh_TW.ts
