Contributing to STAMP Core
============================

The STAMP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the STAMP Core project, and is not to be
confused with overall STAMP Network Protocol consensus changes.

Whether a pull request is merged into STAMP Core rests with the project merge
...
Patches that change STAMP consensus rules are considerably more involved than
...
Where a patch set proposes to change the STAMP consensus, it must have been
...
The project leader is the release manager for each STAMP Core release.
