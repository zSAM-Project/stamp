...
#   c) node1 mines 32 blocks, so now node 0 has 60001sam, node 1 has 4250sam, node2 has none.
#   d) node0 sends 601 sam to node2, in two transactions (301 sam, then 300 sam).
