...
In order to support loading of multiple wallets in stamp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stamp.cpp.
...
Changes to stamp.cpp
----------------------
stamp.cpp is the entry point into stamp-qt, and as such, will require some minor modifications to provide hooks for
