TOR SUPPORT IN STAMP
=======================

It is possible to run STAMP as a Tor hidden service, and connect to such services.
...
Run STAMP behind a Tor proxy
----------------------------------

The first step is running STAMP behind a Tor proxy. This will already make all
...
```
./stampd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./stampd -proxy=127.0.0.1:9050
```

Run a STAMP hidden server
-------------------------------
...
-externalip=X   You can tell stamp about its publicly reachable address using
                ...
                /var/lib/tor/stamp-service/hostname. Onion addresses are given
...
```
./stampd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./stampd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known STAMP Tor relays
------------------------------------
```
